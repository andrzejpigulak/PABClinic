...
public class VisitFabrik {
    ...
    public VisitFabrik() {
        ...
        visitsList.add(new Visit("8:00", "2021-02-15", doktorList.getDoctorList().get(2), patientFabrik.getPatientsList().get(0)));
        visitsList.add(new Visit("8:30", "2021-02-15", doktorList.getDoctorList().get(2), patientFabrik.getPatientsList().get(1)));
        visitsList.add(new Visit("9:00", "2021-02-15", doktorList.getDoctorList().get(2), patientFabrik.getPatientsList().get(2)));
        visitsList.add(new Visit("9:30", "2021-02-15", doktorList.getDoctorList().get(2), patientFabrik.getPatientsList().get(3)));
        visitsList.add(new Visit("10:00", "2021-02-15", doktorList.getDoctorList().get(2), patientFabrik.getPatientsList().get(4)));
